...
export function useFocusTrap(active = true) {
  ...
  const getFocusableElements = useCallback((element: HTMLElement | null) => {
    ...
    // Optimización: Usar try-catch para manejar posibles errores en entornos donde window no está disponible
    try {
      ...
      console.warn("Error al obtener elementos focusables:", error)
      return []
    }
  }, [])

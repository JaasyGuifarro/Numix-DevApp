    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 rounded-full p-2 text-gray-400 opacity-70 ring-offset-background transition-opacity hover:opacity-100 hover:bg-white/10 focus:outline-none disabled:pointer-events-none"
